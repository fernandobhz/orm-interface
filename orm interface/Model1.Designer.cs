...
namespace WindowsFormsApplication1
{
    ...
    public partial class Model1Container : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<Entity2> Entity2Set
        {
            get
            {
                if ((_Entity2Set == null))
                {
                    _Entity2Set = base.CreateObjectSet<Entity2>("Entity2Set");
                }
                return _Entity2Set;
            }
        }
        private ObjectSet<Entity2> _Entity2Set;
        ...
        /// <summary>
        /// Deprecated Method for adding a new object to the Entity2Set EntitySet. Consider using the .Add method of the associated ObjectSet&lt;T&gt; property instead.
        /// </summary>
